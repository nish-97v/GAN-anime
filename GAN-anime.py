...
iterations = 10000
batch_size = 20
save_dir = 'C:/Users/sport/Google Drive/First Semester/Topics in DS/FinalProject/4.12/gan_images_64x64_4th/'
...
for step in range(iterations):
    ...
    if step % 100 == 0:
        ...
        plt.ylabel("Loss (%)")
        plt.legend()
        plt.savefig(save_dir +"Loss-Plot{}".format(step+10000))
